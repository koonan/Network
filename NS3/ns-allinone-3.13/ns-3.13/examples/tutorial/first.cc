...
main (int argc, char *argv[])
{
  ...
  NetDeviceContainer d1d4 = pointToPoint.Install (nodes.Get(1),nodes.Get(4));
  NetDeviceContainer d2d4 = pointToPoint.Install (nodes.Get(2),nodes.Get(4));
  NetDeviceContainer d3d4 = pointToPoint.Install (nodes.Get(3),nodes.Get(4));
  NetDeviceContainer d4d5 = pointToPoint.Install (nodes.Get(4),nodes.Get(5));
  ...
  pointToPoint.EnablePcapAll ("dynamic-global-routing");
